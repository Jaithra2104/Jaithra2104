...
> A high-resolution square portrait is needed to generate an accurate ASCII rendering.
> Once you upload one, it will be converted and placed here, with the full render saved to
> `assets/profile-ascii.txt`.
...
│                                            │
│   Upload a square, high-res headshot to   │
│   generate premium ASCII art here.        │
│                                            │
└──────────────────────────────────────────┘
```
